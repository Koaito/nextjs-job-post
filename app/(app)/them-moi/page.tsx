...
//
// Phạm vi ROUND NÀY (đã chốt với user trước khi code):
...
// chung cho tab Job (và sau này cả tab Công ty/Người liên hệ khi làm ở
// Nhóm 2) — đúng lý do _add_hub_context() tồn tại riêng bên Flask (xem
// docstring blueprints/add_hub.py): "company list cần load ĐÚNG 1 LẦN,
// dùng chung cho cả tab job và tab contact... để KHÔNG ai vô tình gọi
// lại 2-3 lần".
//
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <AddHubTabs
        ...
        companyPanel={<ComingSoonPanel label="công ty" />}
